 ...
 */
define( 'DUSTLANDEXPRESS_THEME_VERSION' , '1.2.7' );
...
function dustlandexpress_theme_scripts() {
	...
	if ( get_theme_mod( 'kra-header-layout', false ) == 'kra-header-layout-centered' ) {
...
function dustlandexpress_load_customizer_script() {
    ...
    $dustlandexpress_upgrade_button = array(
		'link' => admin_url( 'themes.php?page=theme_info' ),
		'text' => __( 'Upgrade to Dustland Express Premium', 'dustland-express' )
	);
	wp_localize_script( 'dustlandexpress-customizer-js', 'upgrade_button', $dustlandexpress_upgrade_button );
