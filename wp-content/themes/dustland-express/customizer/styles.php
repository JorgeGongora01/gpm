...
if ( ! function_exists( 'customizer_library_dustlandexpress_build_styles' ) && class_exists( 'Customizer_Library_Styles' ) ) :
/**
 ...
 * @return void
 */
function customizer_library_dustlandexpress_build_styles() {
...
add_action( 'customizer_library_styles', 'customizer_library_dustlandexpress_build_styles' );

if ( ! function_exists( 'customizer_library_dustlandexpress_styles' ) ) :
/**
 ...
 * @return void
 */
function customizer_library_dustlandexpress_styles() {
...
add_action( 'wp_head', 'customizer_library_dustlandexpress_styles', 11 );