            ...
            <div class="site-top-bar-right">
                ...
                if ( dustlandexpress_is_woocommerce_activated() ) { ?>
                    ...
                    <?php if ( !is_user_logged_in() ) { ?>
                        <div class="site-header-right-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login','dustland-express'); ?>"><?php _e('Sign In / Register','dustland-express'); ?></a></div>
                    <?php } ?>
...
<div class="site-container">
    ...
    <div class="site-header-branding <?php echo ( get_header_image() ) ? 'site-header-branding-img' : ''; ?>">
