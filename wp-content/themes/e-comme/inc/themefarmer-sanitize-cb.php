 ...
 */
function e_comme_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function e_comme_sanitize_css( $css ) {
 ...
 */
function e_comme_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function e_comme_sanitize_email( $email, $setting ) {
 ...
 */
function e_comme_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function e_comme_sanitize_html( $html ) {
 ...
 */
function e_comme_sanitize_image( $image, $setting ) {
 ...
 */
function e_comme_sanitize_nohtml( $nohtml ) {
 ...
 */
function e_comme_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function e_comme_sanitize_number_range( $number, $setting ) {
 ...
 */
function e_comme_sanitize_select( $input, $setting ) {
 ...
 */
function e_comme_sanitize_url( $url ) {
