 ...
 */
/** nav-menu-walker	*/
class e_comme_nav_walker extends Walker_Nav_Menu {
...
function e_comme_nav_menu_css_class($classes) {
...
add_filter('nav_menu_css_class', 'e_comme_nav_menu_css_class');

function e_comme_fallback_page_menu($args = array()) {
	...
	$list_args['title_li'] = '';
	$list_args['walker']   = new e_comme_walker_page_menu;
...
function e_comme_page_menu_args($args) {
...
add_filter('wp_page_menu_args', 'e_comme_page_menu_args');

class e_comme_walker_page_menu extends Walker_Page {
	function start_lvl(&$output, $depth = 0, $args = array()) {
		$indent = str_repeat("\t", $depth);
		$output .= "\n$indent<ul class='dropdown-menu'>\n";
	}
